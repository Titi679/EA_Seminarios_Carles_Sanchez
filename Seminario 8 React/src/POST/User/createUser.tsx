...
function CreateUser({ updateUserList, users }: CreateUserProps) {
    ...
    const validateField = (fieldName: string, value: string) => {
        ...
        switch (fieldName) {
            ...
            case 'email':
                ...
                break;
            case 'phone_number':
                errorMessage = value.trim() === '' ? 'Phone number is required' : isPhoneNumberExist(value) ? 'Phone number already exists' : '';
                break;
            default:
                break;
        }
    ...
    const isPhoneNumberExist = (phone: string) => {
